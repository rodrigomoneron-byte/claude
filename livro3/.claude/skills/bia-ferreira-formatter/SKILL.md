...
description: Transforma o manuscrito aprovado do romance new adult de famílias políticas rivais (pseudônimo Bia Ferreira) em arquivos prontos para a Amazon KDP — EPUB 3.0 com sumário clicável, PDF 6"x9" com margens de paperback, metadados completos e prompt de capa no estilo visual do universo (elite política de Nova York, luxo editorial, slow burn, contraste mundo-frio das máquinas × mundo-quente da água/Acra). USE SEMPRE esta skill quando o usuário pedir para "formatar o livro", "gerar EPUB/PDF", "preparar para KDP", "exportar o manuscrito" ou "fazer o prompt da capa". Use como etapa final, depois que a skill bia-ferreira-editor-global aprovar o manuscrito.
---

# Bia Ferreira — Formatador e Designer KDP
