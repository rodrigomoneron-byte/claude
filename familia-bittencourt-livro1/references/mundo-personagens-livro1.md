# Mundo e Personagens — Família Bittencourt, Livro 1: Acordo de Vidro

## Elenco principal
- **Isabela Bittencourt**, 28-30 anos. Herdeira do império Bittencourt
  (setor a definir na escrita — sugestão: grupo diversificado com base
  histórica em varejo de luxo/imóveis, adequado a "império à beira da
  falência" sem precisar nomear banco/instituição real). Pragmática,
  orgulhosa, sufocada pelo próprio senso de responsabilidade familiar.
- **Leonardo "Leo" Vasconcelos**, 30-32 anos. CEO/fundador de uma
  startup de tecnologia (setor a definir — sugestão: fintech ou
  logística B2B, coerente com "concorrente" da Bittencourt de forma
  indireta, ou parceiro estratégico que Pedro tentou cooptar). Passado
  humilde, ambicioso, charmoso.

## Elenco de apoio
- **Dona Sofia Bittencourt** — avó, matriarca, autora da cláusula do
  testamento.
- **Pedro Bittencourt** — primo, antagonista interno, rival na empresa.
- **Mariana** — melhor amiga de Isabela.
- **Gustavo** — sócio/melhor amigo de Leo.
- **Advogado da família** — nome a definir na escrita.

## Ambientação
São Paulo — Jardins, Morumbi, Faria Lima, restaurantes e galerias de
alta sociedade. Empresas e instituições fictícias (nenhuma marca real
nomeada, seguindo o padrão da casa). Época contemporânea.

## Regras fixas do mundo
- Português brasileiro real, com ambientação e cultura paulistana
  explícitas — DIFERENTE das séries anteriores da casa (Jogo Infinito,
  ambientada em NY/Europa, evitava brasileirismo deliberadamente).
- Régua absoluta MANTIDA: só "nós", nunca "a gente" — em narração nem
  em diálogo de nenhum personagem, mesmo que o registro coloquial
  brasileiro real usasse "a gente" naturalmente. Essa é a marca
  mecânica da casa, não do cenário — não muda com a ambientação.
- Nenhuma marca/instituição financeira ou empresa real nomeada.
- Isolamento de universo: nenhum nome, símbolo ou fato de Jogo
  Infinito, Gelo e Sangue, ou qualquer outro livro/série da casa é
  reaproveitado aqui — elenco, mundo e símbolos são inteiramente novos.
- Pedro Bittencourt pode agir de má-fé (diferente da regra de Jogo
  Infinito) — mas evitar caricatura pura: dar a ele motivação
  compreensível (ex: sempre foi preterido pelo avô apesar de ter
  "trabalhado mais", ressentimento real, não maldade gratuita).
- Dona Sofia nunca é vilã — a cláusula do testamento tem segundas
  intenções, mas vindas de amor genuíno mal comunicado, reveladas com
  dignidade no Ato 3.

## Símbolo do título — DECIDIDO (cap. 3)
Duas taças de cristal, herança do casamento de Dona Sofia com Otávio
Bittencourt (o avô falecido), guardadas na sala de Dona Sofia e usadas
por tradição em brindes que a família considera importantes. Aparecem
pela primeira vez no escritório do Dr. Salgado (cap. 3, servindo de
peso de papel — primeiro presságio visual, antes mesmo do brinde
oficial) e formalmente no brinde da assinatura do contrato de
casamento (cap. 9). Nesse brinde, Isabela nota uma fenda fina na borda
de uma das taças, invisível até a luz bater no ângulo certo — símbolo
recorrente de "imperfeição escondida sob o brilho" / "o que parece
perfeito pode não aguentar o peso real de um brinde". A taça rachada
é guardada por Isabela num armário fechado após o cap. 9. Reaparece
em menção no cap. 13 (taça de vinho do par que sobrou, no jantar de
família) e em referência interna no cap. 17 ("a régua que desenhamos
está rachando"). Reservado para uso futuro nos Atos 2 e 3: a
rachadura se aprofundar ou a taça quebrar de vez num momento de
crise real (queda do acordo), e/ou uma cena de reparo/transparência
no clímax final (Ato 3) como imagem de resolução do símbolo do
título.

## Log de decisões de escrita (capítulos 1-18, Ato 1 — "O Acordo")

### Setores das empresas (definidos no cap. 1-2)
- **Grupo Bittencourt**: conglomerado familiar fundado por Otávio
  Bittencourt. Dois braços citados na escrita: **Bittencourt Casa**
  (rede de lojas de departamento/varejo de luxo, decoração, o negócio
  histórico da família) e uma frente de real estate/incorporação
  (mencionada como "varejo físico" e "empreendimentos" nos caps. 1 e
  3, sem nome de marca fixado ainda — sugestão pra próximos capítulos:
  "BTC Empreendimentos" caso o enredo precise nomear formalmente).
  Crise: queda trimestral (-18,4% no cap. 1), pressão de e-commerce e
  fast fashion sobre o varejo físico, fechamentos de loja na região da
  Faria Lima citados como pano de fundo ambiental.
- **Nexo (Nexo Capital)**: fintech B2B fundada por Leo, sediada num
  galpão na Vila Olímpia. Linha de negócio: crédito e antecipação de
  recebíveis pra varejistas pequenos/médios — concorrente indireta de
  um possível braço financeiro do Grupo Bittencourt, o que sustenta a
  "rivalidade corporativa" da marca 4. Logo: três linhas cruzando em
  X, desenhado por Leo num guardanapo. Investidor-chave citado:
  "Kaique" (fundo/investidor pessoa física, não nomeado como empresa),
  prazo de rodada Série B usado como relógio de pressão em Leo desde
  o cap. 2, fechada com sucesso no cap. 14 (parcialmente por causa do
  sobrenome Bittencourt — fonte de culpa de Leo).

### Elenco definido/nomeado na escrita
- **Isabela Bittencourt** — neta de Otávio e Dona Sofia; pai (Ricardo,
  falecido) não detalhado em cena ainda, mencionado indiretamente
  como "meu tio" (pai de Pedro) sendo o filho vivo de Dona Sofia,
  preterido na sucessão a favor de Isabela — motivação de Pedro.
- **Leonardo "Leo" Vasconcelos** — origem em Santo Amaro, mãe **Dona
  Rosa** (apresentada em cena no cap. 16), sem menção a pai em cena
  ainda (disponível pra uso em Atos 2-3, se necessário).
- **Dona Sofia Bittencourt** — avó, matriarca, dura mas afetuosa;
  autora da cláusula do testamento (revelada no cap. 3); primeira a
  desconfiar/perceber a aproximação real entre Isabela e Leo (cap. 11
  e 13).
- **Pedro Bittencourt** — primo, CFO/diretor no Grupo Bittencourt,
  quinze anos de casa "do estágio à diretoria" (fala própria, cap. 1);
  motivação estabelecida: ressentimento por ter sido preterido na
  sucessão apesar do tempo de casa. Contrata investigador particular
  (revelado cap. 15) pra provar que o casamento é fachada; confronta
  o casal publicamente no lançamento da rodada da Nexo (cap. 17);
  publica coluna anônima insinuando fraude no testamento (mencionada
  no fechamento do cap. 18) — gancho definido pro Ato 2.
- **Mariana** — melhor amiga de Isabela, confidente, alívio cômico
  leve; introduzida por mensagem de texto no cap. 1, em cena (por
  telefone) nos caps. 3, 7 e 15. Sobrenome ainda não fixado.
  Namorado dela (não nomeado) é a fonte que revela a contratação do
  investigador por Pedro (cap. 15) — thread disponível pra Ato 2.
- **Gustavo** — sócio/melhor amigo de Leo desde o segundo grau,
  cético sobre o acordo mas leal, alívio cômico; presente em quase
  todos os capítulos POV Leo (2, 6, 8, 10, 12, 14). Sobrenome ainda
  não fixado.
- **Dr. Salgado (Salgado Advogados Associados)** — advogado da
  família, figura neutra que conduz a leitura do testamento (cap. 3)
  e a assinatura do contrato de casamento (cap. 9).

### Ambientação nomeada
- **Instituto Vitral** — instituição beneficente fictícia (nome
  escolhido de propósito ecoando o motivo "vidro"), anfitriã do baile
  anual onde Isabela e Leo se conhecem (caps. 2, 4, 5). Local do baile:
  **Solar dos Lírios**, casarão fictício convertido em espaço de
  eventos nos Jardins.
- Residências: apartamento de Dona Rosa em Santo Amaro (cap. 16); casa
  da família Bittencourt no Morumbi (caps. 11, 13); cobertura de
  Isabela (residência do casal desde o cap. 10).

### Cláusulas do contrato de casamento (fixadas no cap. 9, relevantes
pra continuidade)
- Prazo mínimo de convivência formal: 18 meses, renovável por acordo
  mútuo.
- Residência compartilhada obrigatória (nominalmente).
- Separação total de bens.
- Cláusula de saída: aviso de 60 dias, exceto risco à validade
  jurídica perante o testamento nos primeiros 6 meses.
- **Cláusula 7**: proíbe desenvolvimento/declaração de sentimento
  romântico genuíno entre as partes — legalmente inexequível (o
  próprio Dr. Salgado admite isso em cena), mas simbolicamente
  central: é a cláusula que Isabela e Leo quebram no beijo que fecha
  o Ato 1 (cap. 18).

### Heat — decisão de ritmo tomada nos caps. 1-18
Nenhuma cena de heat explícita no Ato 1 (caps. 1-18), por decisão
consciente registrada nos capítulos 10 e 18 (ver `ressalva` no
PROGRESS.json desses capítulos) — a meta original do projeto previa a
primeira cena até o cap. 10, mas a instrução de produção específica
para este arco permitiu adiar (marriage of convenience pede tensão
contida mais longa). O Ato 1 fecha com o primeiro beijo real entre
Isabela e Leo (cap. 18), quebrando a cláusula 7 do contrato, como
gesto que reabre o jogo pro Ato 2 — sem consumar cena de heat ainda.
Consequência pro Ato 2: a meta de 10 cenas ao longo do livro inteiro
fica mais apertada a partir daqui (nenhuma cena feita em 18/55
capítulos) — recomenda-se priorizar a primeira cena de heat cedo no
Ato 2 pra recuperar o ritmo.

### Ritmo de extensão — status ao fim do Ato 1
16.310 palavras em 18 capítulos (média ~906 palavras/capítulo), ritmo
de ~88% da meta linear (56.500 palavras / 55 capítulos). Todos os
capítulos ficaram dentro da faixa 873-946 palavras (piso duro
cumprido em 100% dos casos), mas abaixo do centro da faixa-alvo
