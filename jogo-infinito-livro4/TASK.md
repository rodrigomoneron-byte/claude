# Jogo Infinito — Livro 4: Legado e Reinvenção
...
eliminando de vez a necessidade de passe de reforço pós-produção via
piso de extensão como TRAVA DURA (não só aviso) desde o capítulo 1.

## project_dna (o DNA)
- Bíblia de arco/trama: `references/arco-trama-livro4.md`
- Estado do mundo/canon: `references/mundo-personagens-livro4.md`
...
## Saída esperada
- Capítulos em `outputs/conteudo/jogo4-capituloNN.md`
...
- Piso de extensão por capítulo é TRAVA DURA no `loop_state.py record`
  (recusa registrar capítulo abaixo de 85% da média-alvo sem
  --ressalva explícita) — ver project_dna.md seção 3.
...
reportar ritmo de extensão E de heat dentro da meta, e NENHUM capítulo
deve ter sido registrado abaixo do piso sem ressalva documentada.
