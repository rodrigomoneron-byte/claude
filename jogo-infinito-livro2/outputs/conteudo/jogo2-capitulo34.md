# Jogo Infinito — Livro 2 — Capítulo 34
### POV: Alex

Devon apresenta os próprios achados sobre a relação entre Patricia e
Alexandra numa reunião reservada, o rosto carregando a seriedade
...
ligações telefônicas entre as duas nas últimas seis semanas, segundo
registro de operadora que consegui através de canal legítimo.

O peso da informação atinge com força que sinto crescer devagar,
cada implicação exigindo processamento cuidadoso.

---

— Isso é mais frequente do que qualquer supervisão formal
justificaria — comento, sentindo o próprio instinto de proteção se
firmar.
...
até onde a própria influência dela já se espalhou dentro da minha
empresa.

---

Ligo pra Cami, compartilhando o desenvolvimento assim que ela atende.

— Quatro ligações em seis semanas — repete, processando a
informação. — Isso é padrão real, não coincidência isolada.

— Concordo. O que você acha que devemos fazer?

— Acho que precisamos continuar observando, sem confrontar ainda.
Se Patricia perceber que sabemos, ela pode se tornar mais cuidadosa,
dificultando qualquer prova futura de conluio real, se é que existe
conluio de verdade.
...
— Alex, preciso te perguntar uma coisa — ela continua, o tom mudando
ligeiramente. — Você confia em Patricia, historicamente. Isso está
dificultando você considerar essa possibilidade com objetividade
completa?

A pergunta pesa, porque reconheço, mesmo sem admitir imediatamente,
que talvez ela tenha razão.

— Talvez esteja, sim. Ela provou lealdade real durante a crise do
ano passado, mesmo depois de tanto conflito inicial. É difícil
imaginar ela traindo isso agora.

— Entendo essa dificuldade. Só continue de olhos abertos, mesmo
assim.

— Vou continuar. Prometo.

Desligamos pouco depois, e fico sentado, sentindo o próprio peso da
conversa se acumular — gratidão renovada por ter, ao lado, alguém
